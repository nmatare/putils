...
class FastBigQueryRetrieval(object):
    ...
    """
    def __init__(self, service_file, dataset, export_as = "csv.gz", verbose=True, 
    ...
    def extract_metaata(self):
        table = self.bq_client.get_table(self.temp_table)
        return table.schema
    ...
    def read_csv(self, file_path, **kwargs):
        ...
        return read_csv(filepath_or_buffer=file_path, **kwargs)
